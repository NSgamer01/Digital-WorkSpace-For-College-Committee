// ============================================
// config/firebaseAdmin.js — Firebase Admin SDK
// ============================================
...
if (fs.existsSync(serviceAccountPath)) {
    ...
    // This allows the app to start but token verification will fail
    console.warn('  ⚠️   No Firebase credentials found!');
    console.warn('       Place firebase-service-account.json in server/config/');
